...
<body>
    <div id="mySidenav" class="sidenav">
        <a href="#" onclick="loadContent('app.php'); initMap()"><i class="fas fa-home"></i> <span class="nav-text">Home</span></a>
        <a href="#" onclick="loadContent('profile.php')"><i class="fas fa-user"></i> <span class="nav-text">Profile</span></a>
        <a href="#" onclick="loadContent('assistance.php')"><i class="fas fa-hands-helping"></i> <span class="nav-text">Request Help</span></a>
        <a href="#" onclick="loadContent('offer.php')"><i class="fas fa-hand-holding-heart"></i> <span class="nav-text">Offer Help</span></a>
        <a href="#" onclick="loadContent('about_us.php')"><i class="fas fa-info-circle"></i> <span class="nav-text">About us</span></a>
        <a href="#" onclick="loadContent('user_guide.php')"><i class="fas fa-info-circle"></i> <span class="nav-text">User Guide</span></a>
    </div>
            ...
            <div class="container mt-5">
                <div class="row">
                    <div class="col-12 text-center">
                        ...
                        <button class="btn btn-secondary m-2" onclick="showCoordinates()">Confirm Location</button>
                    </div>
                </div>
                <div class="row mt-3">
                    <div class="col-12">

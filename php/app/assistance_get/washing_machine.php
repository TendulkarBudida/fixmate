...
$sql = "SELECT uname, fname, phoneNo, email, address FROM login_details WHERE profession = 'Washing Machine'";
...
<?php else: ?>
    <div class='alert alert-warning' role='alert'>No user data found for profession: Washing Machine</div>
<?php endif; ?>

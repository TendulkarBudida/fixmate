...
$sql = "SELECT uname, fname, phoneNo, email, address FROM login_details WHERE profession = 'Mechanic'";
...
<?php else: ?>
    <div class='alert alert-warning' role='alert'>No user data found for profession: Mechanic</div>
<?php endif; ?>

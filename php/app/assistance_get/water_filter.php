...
$sql = "SELECT uname, fname, phoneNo, email, address FROM login_details WHERE profession = 'Water Filter'";
...
<?php else: ?>
    <div class='alert alert-warning' role='alert'>No user data found for profession: Water Filter</div>
<?php endif; ?>

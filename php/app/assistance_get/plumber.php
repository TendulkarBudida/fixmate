...
$sql = "SELECT uname, fname, phoneNo, email, address FROM login_details WHERE profession = 'Plumber'";
...
<?php else: ?>
    <div class='alert alert-warning' role='alert'>No user data found for profession: Plumber</div>
<?php endif; ?>
